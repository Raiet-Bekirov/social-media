...
abstract public class AbstractPost implements Serializable {
    ...
    protected StringBuilder showPostInternal(StringBuilder sb, String margin, String firstMargin, boolean withChildren) {
        StringBuilder res = showPostHeader(sb, margin, firstMargin);
    ...
    protected StringBuilder showPostHeader(StringBuilder sb, String margin, String firstMargin) {
        return sb.append(firstMargin).append("ID: ").append(id).append("\n")
