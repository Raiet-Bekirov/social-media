...
//        ComPostIdAndCom.put(lastPostId, message);
    ...
    System.out.println(no_of_accounts);*/
        ...
        System.out.println("--- Create 2 endorsements");
        int id5 = a.createPost("Bill", "Test post for 2 endorsements");
        int end5_1, end5_2;
        try {
            end5_1 = a.endorsePost("Raiet", id5);
            end5_2 = a.endorsePost("Legend", id5);
        } catch (PostIDNotRecognisedException e) {
            throw new RuntimeException(e);
        } catch (NotActionablePostException e) {
            throw new RuntimeException(e);
        }
        int com5_1, com5_2, com5_2_1, com5_2_2;
        try {
            com5_1 = a.commentPost("Raiet", id5, "Comment 1");
            com5_2 = a.commentPost("Legend", id5, "Comment 2");
            com5_2_1 = a.commentPost("Bill", com5_2, "Comment 2.1");
            com5_2_2 = a.commentPost("Raiet", com5_2_1, "Comment 2.2");
        } catch (PostIDNotRecognisedException e) {
            throw new RuntimeException(e);
        } catch (NotActionablePostException e) {
            throw new RuntimeException(e);
...
*/
        ...
        // test delete 2 endorsements
        try {
            System.out.println(a.showIndividualPost(id5));
        } catch (PostIDNotRecognisedException e) {
            throw new RuntimeException(e);
        }
        try {
            System.out.println("--- test delete 2 endorsement");
            a.deletePost(id5);
        } catch (PostIDNotRecognisedException e) {
            throw new RuntimeException(e);
        }
        if (a.getPost(id5) != null) {
            throw new RuntimeException("ERROR! Post not deleted!");
        }
        if (a.getPost(end5_1) != null) {
            throw new RuntimeException("ERROR! Endorsement 1 not deleted!");
        }
        if (a.getPost(end5_2) != null) {
            throw new RuntimeException("ERROR! Endorsement 2 not deleted!");
        }
        System.out.println(a.getPost(com5_1).showPostDetails(new StringBuilder(), true).toString());
        System.out.println(a.getPost(com5_2).showPostDetails(new StringBuilder(), true).toString());
